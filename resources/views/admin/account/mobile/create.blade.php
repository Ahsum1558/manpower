    ...
    <div class="col-12">
        <div class="card card_line">
            <div class="card-header card_headline">
                <h4 class="card-title headline">Create New Mobile Account</h4>
            </div>
            <div class="card-body">
@include('admin.includes.alert')
                <form action="{{ route('admin.mobile.store') }}" class="form-group" method="POST" enctype="multipart/form-data">
                     @csrf
                    <div class="profile-personal-info">
                    @php
                        $get_numbers = 1;
                    @endphp
                    @foreach($mobileaccount_data as $mobileaccount)
                        @php
                            $mobilesl = $mobileaccount['accountsl'];
                            $mobileSerial = $mobilesl ? "MOB" . str_pad(++$get_numbers, 5, '0', STR_PAD_LEFT) : "MOB00001";
                        @endphp
                        <input type="hidden" name="accountsl" value="{{ $mobileSerial }}">
                    @endforeach
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-9">
                                <select id="accountType" name="account_type" class="form-control d-inline-block inline_setup">
                                  ...
                                  <option value="1" {{ old('account_type') == 1 ? 'selected' : '' }}>BKash</option>
                                  <option value="2" {{ old('account_type') == 2 ? 'selected' : '' }}>Nagad</option>
                                  <option value="3" {{ old('account_type') == 3 ? 'selected' : '' }}>Rocket</option>
                            </select>
                            </div>
                        </div>
                        <div class="row mb-2">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-9"><input type="text" name="mobile" class="form-control d-inline-block inline_setup" placeholder="Enter Holder Personal Mobile Number" value="{{ old('mobile') }}">
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-3">
                            ...
                            <div class="col-9"><input type="text" name="holder_address" class="form-control d-inline-block inline_setup" placeholder="Enter Holder Address" value="{{ old('holder_address') }}">
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-3">
