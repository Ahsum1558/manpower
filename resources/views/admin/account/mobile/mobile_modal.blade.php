<!-- Delete -->
<div id="delMobile{{ $mobileaccount->id }}" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Delete Mobile Account</h5>
            ...
            <div class="modal-footer mybtn">
                ...
                <a href="{{ route('admin.mobile.destroy', ['id'=>$mobileaccount->id]) }}" class="form-control inline_setup btn submitbtn text-uppercase">Delete</a>
            </div>
        </div>
    </div>
</div>