                ...
                <form action="{{ route('admin.submission.update', ['id'=>$submission_info->id]) }}" class="form-group" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col">
                        <div class="product-detail-content">
                                ...
                                <div class="row mb-2">
                                        ...
                                        <div class="col-9">
                                            ...
                                            @foreach($all_field as $field)
                                                <option value="{{ $field->id }}" {{ $submission_info->fieldId == $field->id ? 'selected' : '' }}>{{ $field->title.' - '.$field->license }}</option>
                                            @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-9">
                                            ...
                                            @foreach($all_fieldar as $fieldar)
                                                <option value="{{ $fieldar->id }}" {{ $submission_info->fieldarId == $fieldar->id ? 'selected' : '' }}>{{ $fieldar->title_ar.' - '.$fieldar->license_ar }}</option>
                                            @endforeach
                                            </select>                        
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-9">
                                            ...
                                            @foreach($all_fieldbn as $fieldbn)
                                                <option value="{{ $fieldbn->id }}" {{ $submission_info->fieldbnId == $fieldbn->id ? 'selected' : '' }}>{{ $fieldbn->title_bn.' - '.$fieldbn->license_bn }}</option>
                                            @endforeach
                                            </select>                        
                                        </div>
                                    </div>
                            ...
                            @if($submission_info->status == 1)
                                      <option selected="selected" value="1">Active</option>
                                      <option value="0">Inactive</option>
                              @elseif($submission_info->status == 0)
