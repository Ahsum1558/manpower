<!-- active -->
<div id="activeId{{ $customer->id }}" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.customer.active', ['id'=>$customer->id]) }}" class="form-group" method="POST" enctype="multipart/form-data">
                @csrf
