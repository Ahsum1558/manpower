    ...
    <div class="card card_line">
        ...
        <div class="card-body">
            ...
            @if($customer_single_data[0]->value == 2)
                <a class="btn submitbtn mb-2 form-control inline_setup text-uppercase" href="{{ route('admin.customer.embassyAdd', ['id'=>$customer_single_data[0]->id]) }}">Add Embassy Info</a>
            @else
