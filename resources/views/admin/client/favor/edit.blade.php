    ...
    <div class="col-12">
        <div class="card card_line">
            <div class="card-header card_headline">
                <h4 class="card-title headline">Update Support Agent Info of <strong>{{ $favor_data_info[0]->favor_office .' - '. $favor_data_info[0]->favor_license }}</strong></h4>
            </div>
            <div class="card-body">
@include('admin.includes.alert')
                <form action="{{ route('admin.favor.update', ['id'=>$favor_data_info[0]->id]) }}" class="form-group" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                    <!--Tab slider End-->
                    <div class="col">
                        <div class="product-detail-content">
                            ...
                            <div class="new-arrival-content pr">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-9"><input type="text" name="favorname" class="form-control d-inline-block inline_setup" value="{{ $favor_data_info[0]->favorname }}">
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-3">
                                    ...
                                    <div class="col-9"><input type="text" name="father" class="form-control d-inline-block inline_setup" value="{{ $favor_data_info[0]->father }}">
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-3">
                                    ...
                                    <div class="col-9"><input type="text" name="phone" class="form-control d-inline-block inline_setup" value="{{ $favor_data_info[0]->phone }}">
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-3">
                                    ...
                                    <div class="col-9"><input type="date" name="dateOfBirth" class="form-control d-inline-block inline_setup" value="{{ $favor_data_info[0]->dateOfBirth }}" max="{{ date('Y-m-d') }}">
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-3">
                            ...
                            @if($favor_data_info[0]->gender == 1)
                                      <option selected="selected" value="1">Male</option>
                                      <option value="2">Female</option>
                                      <option value="3">Other</option>
                              @elseif($favor_data_info[0]->gender == 2)
                              ...
                              @endif
                                ...
                                <div class="row mb-2">
                                    <div class="col-3">
                                        <h5 class="f-w-500">Support Agent NID <span class="pull-right">:</span></h5>
                                    </div>
                                    <div class="col-9"><input type="text" name="nid" class="form-control d-inline-block inline_setup" value="{{ $favor_data_info[0]->nid }}">
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-3">
                                    ...
                                    <div class="col-9"><input type="text" name="office_address" class="form-control d-inline-block inline_setup" value="{{ $favor_data_info[0]->office_address }}">
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-3">
                                    ...
                                    <div class="col-9"><input type="text" name="accountNo" class="form-control d-inline-block inline_setup" value="{{ $favor_data_info[0]->accountNo }}">
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-3">
                                    ...
                                    <div class="col-9"><input type="text" name="bankname" class="form-control d-inline-block inline_setup" value="{{ $favor_data_info[0]->bankname }}">
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-3">
                                    ...
                                    <div class="col-9"><input type="text" name="bankbranch" class="form-control d-inline-block inline_setup" value="{{ $favor_data_info[0]->bankbranch }}">
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-3">
                                    ...
                                    <div class="col-9"><input type="text" name="address" class="form-control d-inline-block inline_setup" value="{{ $favor_data_info[0]->address }}">
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-3">
                                    ...
                                    <div class="col-9"><input type="text" name="zipcode" class="form-control d-inline-block inline_setup" value="{{ $favor_data_info[0]->zipcode }}">
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-3">
                                    ...
                                    @foreach($all_country as $country)
                                      <option value="{{ $country->id }}" {{ $favor_data_info[0]->countryId == $country->id ? 'selected' : '' }}>{{ $country->countryname }}</option>
                                    @endforeach
                                    </select>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    ...
                                    @foreach($all_division as $division)
                                      <option value="{{ $division->id }}" {{ $favor_data_info[0]->divisionId == $division->id ? 'selected' : '' }}>{{ $division->divisionname }}</option>
                                    @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    ...
                                    @foreach($all_district as $district)
                                      <option value="{{ $district->id }}" {{ $favor_data_info[0]->districtId == $district->id ? 'selected' : '' }}>{{ $district->districtname }}</option>
                                    @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    ...
                                    @foreach($all_city as $city)
                                        <option value="{{ $city->id }}" {{ $favor_data_info[0]->cityId == $city->id ? 'selected' : '' }}>{{ $city->cityname }}</option>
                                    @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    ...
                                    @foreach($all_upzila as $upzila)
                                        <option value="{{ $upzila->id }}" {{ $favor_data_info[0]->policestationId == $upzila->id ? 'selected' : '' }}>{{ $upzila->policestationname }}</option>
                                    @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    ...
                                    <div class="col-9"><input type="text" name="description" class="form-control d-inline-block inline_setup" value="{{ $favor_data_info[0]->description }}">
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-3">
                            ...
                            @if($favor_data_info[0]->status == 1)
                                      <option selected="selected" value="1">Active</option>
                                      <option value="0">Inactive</option>
                              @elseif($favor_data_info[0]->status == 0)
                              ...
                              @endif
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-9 mybtn">
                                        ...
                                        <a class="btn submitbtn mb-2 form-control inline_setup text-uppercase pull-right" href="{{ route('admin.favor.show', ['id'=>$favor_data_info[0]->id]) }}">Back</a>
                                    </div>
                                </div>
                            </div>
                        </div>
