    ...
    <div class="row content registration-form"> <!-- .login-form -->
        <div class="col-12 pl-0 pr-0">
            <div class="form-group">
                <div class="col-sm-12">
                    <h4 class="text-center font-weight-bold font-italic mt-3">User Info Update</h4>
                </div>
            </div>
            <form method="POST" action="{{ route('user-info-update') }}" enctype="multipart/form-data" autocomplete="off" class="form-inline">
                ...
                <div class="form-group col-12 mb-3">
                    ...
                    <button type="submit" class="col-sm-9 btn btn-block my-btn-submit">{{ __('Update') }}</button>
                </div>
            </form>
        </div>
    </div>
