...
@include('admin.includes.alert')
                <form action="{{ route('admin.policestation.store') }}" class="form-group" method="POST" enctype="multipart/form-data">
                     @csrf
                    <div class="profile-personal-info">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-9"><input type="text" name="policestationname" class="form-control d-inline-block inline_setup" placeholder="Enter Police Station Name">
                            </div>
                        </div>
