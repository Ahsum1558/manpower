...
@include('admin.includes.alert')
                <form action="{{ route('admin.issue.updateInfo', ['id'=>$issue_data_info[0]->id]) }}" class="form-group" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                    <!--Tab slider End-->
                    <div class="col">
                            ...
                            <div class="new-arrival-content pr">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-9 mybtn">
                                        ...
                                        <a class="btn submitbtn mb-2 form-control inline_setup text-uppercase pull-right" href="{{ route('admin.issue.show', ['id'=>$issue_data_info[0]->id]) }}">Back</a>
                                    </div>
                                </div>
                            </div>
                        </div>
