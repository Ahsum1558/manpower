...
<div class="deznav" id="nav_menu">
    <div class="deznav-scroll">
        <ul class="metismenu" id="menu">
            <li><a href="{{ url('/travel') }}" class="ai-icon" aria-expanded="false">
            ...
            <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="{{ route('travel.profile') }}">Profile</a></li>
                    <li><a href="{{ route('travel.theme') }}">Theme Option</a></li>
                @if(Auth::user()->role == 'admin')
                    <li><a href="{{ route('travel.operator') }}">All Operator</a></li>
                @endif                    
                </ul>
            </li>
            {{-- <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="{{ route('travel.country') }}">Country</a></li>
                    <li><a href="{{ route('travel.division') }}">Division</a></li>
                    <li><a href="{{ route('travel.district') }}">District</a></li>
                    <li><a href="{{ route('travel.policestation') }}">Police Station</a></li>
                    <li><a href="{{ route('travel.city') }}">City</a></li>
                    <li><a href="{{ route('travel.issue') }}">Issue Place</a></li>
                </ul>
            </li> --}}
            {{-- <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
        ...
        @endif --}}
            ...
            <li><a href="{{ url('travel/logout') }}" class="ai-icon" aria-expanded="false">
