...
@foreach($travel_headers as $header)
...
@foreach($travel_headers as $header)
            <a href="{{ url('/travel') }}" class="brand-logo">
                        ...
                        <ul class="navbar-nav header-right">
                            <li class="nav-item dropdown header-profile">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="{{ route('travel.profile') }}" class="dropdown-item ai-icon">
                                        <i class="fas fa-user"></i>
                                        <span class="ml-2">Profile </span>
                                    </a>
                   
                                    <a href="{{ url('travel/logout') }}" class="dropdown-item ai-icon logout_option"><i class='fas fa-sign-out-alt'></i>
