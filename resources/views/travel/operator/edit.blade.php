...
@include('travel.includes.alert')
                <form action="{{ route('travel.operator.update', ['id'=>$user_info->id]) }}" class="form-group" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                    <!--Tab slider End-->
                    <div class="col">
                              ...
                              @endif
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-9 mybtn">
                                        ...
                                        <a class="btn submitbtn mb-2 form-control inline_setup text-uppercase pull-right" href="{{ route('travel.operator.show', ['id'=>$user_info->id]) }}">Back</a>
                                    </div>
                                </div>
                            </div>
                        </div>
