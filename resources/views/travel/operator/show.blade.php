        ...
        <div class="card card_line">
            ...
            <div class="card-body">
                ...
                @if(Auth::user()->role == 'admin' && Auth::user()->id !== $single_user->id)
                    <a class="btn submitbtn mb-2 form-control inline_setup text-uppercase" href="{{ route('travel.operator.edit', ['id'=>$single_user->id]) }}">Update Info</a>
                @endif
                    <a class="btn submitbtn mb-2 form-control inline_setup text-uppercase pull-right" href="{{ route('travel.operator') }}">Back</a>
                </div>
            </div>
        </div>
    </div>
