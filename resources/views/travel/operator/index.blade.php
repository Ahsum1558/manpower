...
<div class="mybtn">
  <a href="{{ route('travel.operator.create') }}" class="btn submitbtn mb-2 form-control inline_setup text-uppercase">Add New Operator</a>
</div>
<div class="row">
        ...
        <div class="card card_line">
            ...
            <div class="card-body">
              ...
              <div class="table-responsive">
                  <table id="example" class="display" style="min-width: 700px">
                      ...
                      @foreach($all_adminuser as $admin_user)
                        <tr>
                            ...
                            <td>
                              <a class="view_option" href="{{ route('travel.operator.show', ['id'=>$admin_user->id]) }}"><i class="fas fa-eye"></i><span>View Operator</span></a>
                ...
                @include('travel.operator.users_modal')
                @include('travel.operator.users_inactive')
                @include('travel.operator.users_active')
                        </tr>
                @endforeach
                      </tbody>
                  </table>
