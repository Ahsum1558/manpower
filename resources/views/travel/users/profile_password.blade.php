...
@include('travel.includes.alert')
    ...
    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="javascript:void(0)">Password Update</a></li>
        </ol>
    </div>
</div>
    ...
    <div class="col-xl-12 col-lg-12">
        <div class="card card_line">
            <div class="card-header card_headline">
               <h4 class="card-title headline">Profile Password Update</h4>
            </div>
            <div class="card-body">
                <h4 class="mb-4 basic_headline">Update Password</h4>
                <div class="profile-uoloaded-post border-bottom-1 pb-5">
                    <form action="{{ route('travel.profile.passwordUpdate') }}" class="form-group" method="POST" enctype="multipart/form-data">
                        @csrf
