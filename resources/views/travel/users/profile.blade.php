    ...
    <div class="col-xl-12 col-lg-12">
        <div class="card card_line">
            ...
            <div class="card-body">
                ...
                <div class="mybtn">
                    <a class="btn submitbtn mb-2 form-control inline_setup text-uppercase" href="{{ route('travel.profile.info') }}">Update Info</a>
                    <a class="btn submitbtn mb-2 form-control inline_setup text-uppercase" href="{{ route('travel.profile.username') }}">Update Username</a>
                    <a class="btn submitbtn mb-2 form-control inline_setup text-uppercase" href="{{ route('travel.profile.email') }}">Update E-Mail</a>
                    <a class="btn submitbtn mb-2 form-control inline_setup text-uppercase" href="{{ route('travel.profile.image') }}">Update Image</a>
                    <a class="btn submitbtn mb-2 form-control inline_setup text-uppercase" href="{{ route('travel.profile.password') }}">Update Password</a>
                </div>
            </div>
        </div>
    </div>
