        ...
        <div class="card card_line">
            ...
            <div class="card-body">
                ...
                <div class="profile-uoloaded-post border-bottom-1 pb-5">
                    <form action="{{ route('travel.profile.infoUpdate') }}" class="form-group" method="POST" enctype="multipart/form-data">
                        @csrf
...
@include('travel.includes.loader')
...
<script>
    $(document).ready(function(){
        $('#select').change(function() {
            ...
            if(countryId){
                $('#overlay .loader').show();
                $.get("{{ route('travel.profile.get') }}", {country_id:countryId}, function(data){
                    $('#overlay .loader').hide();
                    console.log(data);
        ...
        $('#single-select').change(function() {
            ...
            if(divisionId && countryId){
                $('#overlay .loader').show();
                $.get("{{ route('travel.profile.getDistrict') }}", {division_id:divisionId, country_id:countryId}, function(data){
                    $('#overlay .loader').hide();
                    console.log(data);
        ...
        $('#id_label_single').change(function() {
            ...
            if(districtId && divisionId && countryId){
                $('#overlay .loader').show();
                $.get("{{ route('travel.profile.getCity') }}", {district_id:districtId, division_id:divisionId, country_id:countryId}, function(data){
                    $('#overlay .loader').hide();
                    console.log(data);
        ...
        $('#id_label_single').change(function() {
            ...
            if(districtId && divisionId && countryId){
                $('#overlay .loader').show();
                $.get("{{ route('travel.profile.getUpzila') }}", {district_id:districtId, division_id:divisionId, country_id:countryId}, function(data){
                    $('#overlay .loader').hide();
                    console.log(data);
