    ...
    <div class="col-12">
        <div class="card card_line">
            <div class="card-header card_headline">
                <h4 class="card-title headline">Create New Travel Setup Option Information</h4>
            </div>
            <div class="card-body">
@include('super.includes.alert')
                <form action="{{ route('super.travelset.store') }}" class="form-group" method="POST" enctype="multipart/form-data">
                     @csrf
