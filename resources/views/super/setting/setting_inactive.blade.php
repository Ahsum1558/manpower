<!-- Inactive -->
<div id="inActiveId{{ $header_footer->id }}" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Inactive Header and Footer</h5>
                <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
                </button>
            </div>
            <form action="{{ route('super.setting.inactive', ['id'=>$header_footer->id]) }}" class="form-group" method="POST" enctype="multipart/form-data">
                @csrf
