<!-- Delete -->
<div id="delOperator{{ $super_user->id }}" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer mybtn">
                ...
                <a href="{{ route('super.operator.destroy', ['id'=>$super_user->id]) }}" class="form-control inline_setup btn submitbtn text-uppercase">Delete</a>
            </div>
        </div>
    </div>
</div>