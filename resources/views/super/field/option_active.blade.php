<!-- active -->
<div id="activeId{{ $field->id }}" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('super.field.active', ['id'=>$field->id]) }}" class="form-group" method="POST" enctype="multipart/form-data">
                @csrf
