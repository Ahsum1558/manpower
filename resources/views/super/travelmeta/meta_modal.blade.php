<div id="viewMeta{{ $meta_travel->id }}" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Travel Meta Information</h5>
            ...
            <div class="modal-body">
            	<div class="card card_line">
                    <div class="card-header card_headline">
                        <h4 class="card-title headline">Travel Meta Information Details</h4>
                    </div>
                    <div class="card-body">
                                    ...
                                    <div class="product-detail-content">
                                        ...
                                        <div class="new-arrival-content pr">
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-8"><span>{{ $meta_travel->title }}</span>
                                                </div>
                                            </div>
                                            <div class="row mb-2">
                                                <div class="col-4">
                                                ...
                                                <div class="col-8"><span>{{ $meta_travel->meta_title }}</span>
                                                </div>
                                            </div>
                                            <div class="row mb-2">
                                                <div class="col-4">
                                                ...
                                                <div class="col-8"><span>{{ $meta_travel->description }}</span>
                                                </div>
                                            </div>
                                            <div class="row mb-2">
                                                <div class="col-4">
                                                ...
                                                <div class="col-8"><span>{{ $meta_travel->meta_description }}</span>
                                                </div>
                                            </div>
                                            <div class="row mb-2">
                                                <div class="col-4">
                                                ...
                                                <div class="col-8"><span>{{ $meta_travel->url }}</span>
                                                </div>
                                            </div>
                                            <div class="row mb-2">
                                                <div class="col-4">
                                                ...
                                                <div class="col-8"><span>{{ $meta_travel->meta_keywords }}</span>
                                                </div>
                                            </div>
                                            <div class="row mb-2">
                                                <div class="col-4">
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-9"><span>{{ date('d-M-Y', strtotime($meta_travel->created_at)) }}</span>
                                                </div>
                                            </div>
