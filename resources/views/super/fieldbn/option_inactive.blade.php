<!-- Inactive -->
<div id="inActiveId{{ $fieldbn->id }}" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Inactive Site Option</h5>
                <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
                </button>
            </div>
            <form action="{{ route('super.fieldbn.inactive', ['id'=>$fieldbn->id]) }}" class="form-group" method="POST" enctype="multipart/form-data">
                @csrf
