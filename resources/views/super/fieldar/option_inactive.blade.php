<!-- Inactive -->
<div id="inActiveId{{ $fieldar->id }}" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('super.fieldar.inactive', ['id'=>$fieldar->id]) }}" class="form-group" method="POST" enctype="multipart/form-data">
                @csrf
