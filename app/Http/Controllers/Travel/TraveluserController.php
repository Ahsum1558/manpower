...
class TraveluserController extends Controller
{
    ...
    public function index()
    {
        ...
        if (Auth::user()->role == 'admin') {
            return view('travel.operator.index', compact('all_adminuser'));
        }else{
    ...
    public function create()
    {
        ...
        if (Auth::user()->role == 'admin') {
            return view('travel.operator.create', compact('user_data'));
        }else{
            return redirect('/travel');
        }
    }
    ...
    public function show(string $id)
    {
        ...
        if (Auth::user()->role == 'admin') {
            if($single_user !== null){
                return view('travel.operator.show', compact('single_user'));
            }else{
                return redirect('/travel/operator');
            }
        }else{
            return redirect('/travel');
        }
    ...
    public function edit(string $id)
    {
        ...
        if ($user_info !== null) {
            if (Auth::user()->role == 'admin' && Auth::user()->id !== $user_info->id) {
                return view('travel.operator.edit', compact('user_info'));
                }else{
                    return redirect('/travel');
                }
            }else{
    ...
    public function inactive($id)
    {
        ...
        if (Auth::user()->role == 'admin' && Auth::user()->id !== $user_inactive->id) {
            ...
            return redirect('/travel/operator')->with('message', 'The User is Inactive Successfully');
        }else{
            return redirect('/');
        }
    }
    ...
    public function active($id)
    {
        ...
        if (Auth::user()->role == 'admin' && Auth::user()->id !== $user_active->id) {
            ...
            return redirect('/travel/operator')->with('message', 'The User is Active Successfully');
        }else{
            return redirect('/');
        }
    }
