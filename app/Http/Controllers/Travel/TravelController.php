...
class TravelController extends Controller
{
    public function index(){
        ...
        if (Auth::user()->role == 'admin' || Auth::user()->role == 'editor' || Auth::user()->role == 'contributor') {
            if (Auth::check() && Auth::user()->status === 'active') {
                return view('travel.home.index');
            }elseif(Auth::check() && Auth::user()->status !== 'active') {
                Auth::logout();
                return redirect('/travel/login')->with(['error_message' => 'Your account is inactive. Please contact the administrator.']);
            }
        }else{
            return redirect('/');
        }
    ...
    public function userProfile(){
        if (Auth::user()->role == 'admin' || Auth::user()->role == 'editor' || Auth::user()->role == 'contributor') {
            ...
            return view('travel.users.profile', compact('profile_data'));
        }else{
            return redirect('/');
        }
    }
    ...
    public function getDistrict(Request $request)
    {
        ...
        if (count($all_district)>0) {
            return view('travel.users.ajax_district',[
    ...
    public function getCity(Request $request)
    {
        ...
        if (count($all_city)>0) {
            return view('travel.users.ajax_city',[
                'all_city'=>$all_city,
            ]);
        }
    }
    ...
    public function getUpzila(Request $request)
    {
        ...
        if (count($all_upzila)>0) {
            return view('travel.users.ajax_upzila',[
    ...
    public function profileInfoEdit(){
        if (Auth::user()->role == 'admin' || Auth::user()->role == 'editor' || Auth::user()->role == 'contributor') {
            ...
            return view('travel.users.profile_info', [
                'user_info'=>$user_info,
    ...
    public function profileUsername(){
        if (Auth::user()->role == 'admin' || Auth::user()->role == 'editor' || Auth::user()->role == 'contributor') {
            ...
            return view('travel.users.profile_username', compact('username_data'));
        }else{
            return redirect('/');
        }
    }
    ...
    public function profileEmail(){
        if (Auth::user()->role == 'admin' || Auth::user()->role == 'editor' || Auth::user()->role == 'contributor') {
            ...
            return view('travel.users.profile_email', compact('email_data'));
        }else{
            return redirect('/');
        }
    }
    ...
    public function profileImage(){
        if (Auth::user()->role == 'admin' || Auth::user()->role == 'editor' || Auth::user()->role == 'contributor') {
            ...
            return view('travel.users.profile_image', compact('image_data'));
        }else{
            return redirect('/');
        }
    }
    ...
    public function profilePassword(){
        if (Auth::user()->role == 'admin' || Auth::user()->role == 'editor' || Auth::user()->role == 'contributor') {
            ...
            return view('travel.users.profile_password', compact('password_data'));
        }else{
            return redirect('/');
        }
    }
    ...
    public function userProfileTheme(){
        if (Auth::user()->role == 'admin' || Auth::user()->role == 'editor' || Auth::user()->role == 'contributor') {
            ...
            return view('travel.users.profile_theme', compact('userData'));
        }else{
            return redirect('/');
        }
    }
